...
class LayaAir3D {
    ...
    private scoreBoardUI: ScoreBoardView;
    private roomUI: RoomView;
    private gameOverVideoUI: GameOverVideoView;

    private ballScript: UpdateRoadScript;
    private score: number;

    private socket: Laya.Socket; //WebSocket连接

    private bannerAd: any;
    private videoAd: any;

    private isResurrected: boolean //是否复活过了
    ...
    constructor() {
        ...
        //添加照相机
        var camera: Laya.Camera = (scene.addChild(new Laya.Camera(0, 0.1, 50))) as Laya.Camera;
        ...
        this.ball = scene.addChild(new Laya.MeshSprite3D(new Laya.SphereMesh(0.25, 16, 16), "ball")) as Laya.MeshSprite3D;
        this.ball.transform.position = new Laya.Vector3(.5, 0.75, 0);
        var ballMaterial: Laya.StandardMaterial = new Laya.StandardMaterial();
        ...
        var arrowMaterial: Laya.StandardMaterial = new Laya.StandardMaterial();
        ...
        this.ballScript = this.ball.addComponent(UpdateRoadScript) as UpdateRoadScript;
